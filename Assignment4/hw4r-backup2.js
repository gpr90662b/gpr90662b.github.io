...
lightPosition[0] = -10; lightPosition[1] = -10; lightPosition[2] = 10; lightPosition[3] = 1;
lightPosition[4] =  -10; lightPosition[5] =  10; lightPosition[6] = 10; lightPosition[7] = 0;
lightPosition[8] =  10; lightPosition[9] =  -10; lightPosition[10] = 10; lightPosition[11] = 1;
lightPosition[12] = 10; lightPosition[13] =  10; lightPosition[14] = 10; lightPosition[15] = 0;

alightColor[0]=0.15;alightColor[1]=0.15;alightColor[2]=0.15;alightColor[3]=1;
dlightColor[0]=0; dlightColor[1]=1;dlightColor[2]=0;dlightColor[3]=1;
slightColor[0]=1;slightColor[1]=1;slightColor[2]=1;slightColor[3]=1;

alightColor[4]=0.2;alightColor[5]=0.2;alightColor[6]=0.2;alightColor[7]=1;
dlightColor[4]=1;dlightColor[5]=0;dlightColor[6]=0;dlightColor[7]=1;
slightColor[4]=1;slightColor[5]=1;slightColor[6]=1;slightColor[7]=1;

alightColor[8]=0.1;alightColor[9]=0.1;alightColor[10]=0.1;alightColor[11]=1;
dlightColor[8]=1;dlightColor[9]=0;dlightColor[10]=1;dlightColor[11]=1;
slightColor[8]=1;slightColor[9]=1;slightColor[10]=1;slightColor[11]=1;

alightColor[12]=0.3;alightColor[13]=0.3;alightColor[14]=0.3;alightColor[15]=1;
dlightColor[12]=0;dlightColor[13]=1;dlightColor[14]=1;dlightColor[15]=1;
slightColor[12]=1.0;slightColor[13]=0.5;slightColor[14]=1.0;slightColor[15]=1;
	...
	for (var index = 0; index < objCount; index++) {
        ...
        //model transforms, scale first
            mat4.identity(modelMatrix);
             mat4.translate(modelMatrix, modelMatrix, [-translation[0],-translation[1],-translation[2]] );
            mat4.scale(modelMatrix, modelMatrix, scalexyz);
            mat4.translate(modelMatrix, modelMatrix, translation);
            
            //x axis rotation          
            mat4.rotate(modelMatrix, modelMatrix, degToRad(rotation[0]), [1,-translation[1],-translation[2]] );
            
            //y axis rotation
            mat4.rotate(modelMatrix, modelMatrix, degToRad(rotation[1]),[-translation[0],1,-translation[2]] );
           
            //z axis rotation  
            mat4.rotateZ(modelMatrix, modelMatrix, degToRad(rotation[2]),[-translation[0],-translation[1],1] );
...
objList[objCount].translation = [-1.5, 1, 1]; 
...
objList[objCount].mode = "both";
objList[objCount].translation = [1.5, -1.0, 0.5]; 
