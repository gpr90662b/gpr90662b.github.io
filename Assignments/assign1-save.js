...
function init() {
    ...
    var document.getElementById("triangle").addEventListener("click", eventHandler3() ); 
    document.getElementById("squaere").addEventListener("click", eventHandler3() ); 
    document.getElementById("pentagon").addEventListener("click", eventHandler3() ); 
